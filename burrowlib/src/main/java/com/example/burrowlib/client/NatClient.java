package com.example.burrowlib.client;
...
import com.example.burrowlib.bean.Message;
import com.example.burrowlib.bean.NatResponse;
import com.example.burrowlib.consumer.channel.BaseUDPChannelHandlerImpl;
import com.example.burrowlib.consumer.packet.BasePacketConsumer;
import com.example.burrowlib.consumer.packet.BurrowPacketConsumer;
import com.example.burrowlib.consumer.packet.BurrowReqPacketConsumer;
...
import com.example.jutil.eventbus.anno.Subscribe;
...
public class NatClient {
    ...
    public void registerServer(String host, int port, IRequestObserver observer){
    ...
    void onClientBurrowAction(String token){
        ...
        android.util.Log.e(TAG, "onClientBurrowAction: "+token);
        String respMsg = (String) burrowEvent.getTag();
        android.util.Log.e(TAG, "onClientBurrowAction2: "+respMsg);
        try {
